...
export const PROTOCOL_CONTRACT_ABI = [
  ...
  { inputs: [], name: "BadClaim", type: "error" },
  { inputs: [], name: "BadModule", type: "error" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "tokenId", type: "uint256" },
      { internalType: "uint256", name: "newTariff", type: "uint256" },
    ],
    name: "_setTariff",
    outputs: [],
    stateMutability: "nonpayable",
